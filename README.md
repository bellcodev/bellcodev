...
## 🌟 About Me
- 🔭 Currently working on **Python** projects and web applications with APIs.  
- 🌱 Learning and improving in **JavaScript**, **Python**, and **REST APIs**.  
- 🎯 Goal: Create intuitive and accessible user experiences.  
- 📫 How to reach me: [Email](mailto:belloconcepcionr@gmail.com)  
...
| <img src="https://skillicons.dev/icons?i=python,fastapi,express,sqlite,js,ts,html,css,git,github,vscode" width="1000"/> |
|---|
...
<p>A desktop application built with Python and Tkinter to explore and modify SQLite databases with ease.</p>
</div>
</td>
...
<img src="https://img.shields.io/badge/REPOSITORY-80ffaa?style=for-the-badge&logo=github&logoColor=black">
</a>
</p>
<p>A simple web application that analyzes GitHub profiles using the official API and displays detailed statistics.</p>
</div>
</td>
</tr>
</table>
